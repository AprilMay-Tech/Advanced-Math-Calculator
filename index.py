...
print("34. Solve Linear Functions")
print("35. Solve Quadratic Functions")
print("36. Solve Cubic Functions")
print("37. Solve log and ln Functions")
print("38. Solve log10 Functions")
print("39. Solve y = e^x Functions")
print("40. Solve y = a^x Functions")
print("41. Solve Signum Functions")
print("42. Solve Sinusoidal Functions")
print("43. Solve Sinc Functions")
print("44. Solve Hyperbolic Functions")
print("45. Solve Custom Function")
...
if (choice1 == 1):
    ...
    x3 = float(input("Enter the third 'x' value:\n"))
    ...
    a = float(input("Enter the 'a' value:\n"))
    b = float(input("Enter the 'b' value:\n"))
    c = float(input("Enter the 'd' value:\n"))
    ...
    x2 = float(input("Enter the second 'x' value:\n"))
    x3 = float(input("Enter the third 'x' value:\n"))
    x4 = float(input("Enter the fourth 'x' value:\n"))
    y1 = float(input("Enter the first 'y' value:\n"))
    y2 = float(input("Enter the second 'y' value:\n"))
    y3 = float(input("Enter the third 'y' value:\n"))
    y4 = float(input("Enter the fourth 'y' value:\n"))
    x = np.arange(x1, x2, x3, x4)
    y = np.arange(y1, y2, y3, y4)
    plt.plot(x, y)
    plt.title("Identity Function")
    plt.xlabel("Values of x")
    plt.ylabel("Values of y")
